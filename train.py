...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.COOP.N_CTX_V = 16  # number of context vectors
    cfg.TRAINER.COOP.L_IND = 0  # number of context vectors
    cfg.TRAINER.COOP.CSC = False  # class-specific context
    cfg.TRAINER.COOP.CTX_INIT = False  # initialization words
    cfg.TRAINER.COOP.W = 8.0
    cfg.TRAINER.COOP.W_V = 6.0
...
def setup_cfg(args):
    ...
    if cfg.DATASET.NAME in ["ImageNet","SUN397"] and cfg.DATASET.SUBSAMPLE_CLASSES != 'all': # and cfg.DATASET.SUBSAMPLE_CLASSES != 'all'
