...
class DescribableTextures(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        train, val, test = OxfordPets.subsample_classes(train,
                                                        ...
                                                        subsample=subsample)
    #     data_paths = []
    #     log_path = '/home/zhangzhimin/dtd_fewshot.json'  # 修改为你希望存储的路径
    #     for datum in train:
    # # 假设 Datum 对象有一个 'path' 属性（具体要根据你的 Datum 类来调整）
    #          image_path = datum.impath  # 或者 datum.img_path
    #          data_paths.append({'image_path': image_path})
    ...
    #          f.write('\n')  # 每条记录占一行
    #     pdb.set_trace()
        # log_path2 = '/home/zhangzhimin/dtd_novel_test.json'  # 修改为你希望存储的路径
